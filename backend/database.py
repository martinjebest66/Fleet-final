...
INDEX_SPECS: List[Tuple[str, List[Tuple[str, int]], Dict[str, Any]]] = [
    ...
    ("maintenance_documents", [("document_id", 1)], {"unique": True, "name": "uniq_document_id"}),
    ("maintenance_documents", [("maintenance_id", 1), ("uploaded_at", 1)],
     {"name": "idx_maintenance_uploaded"}),
    ("maintenance_documents", [("vehicle_id", 1)], {"name": "idx_vehicle"}),
