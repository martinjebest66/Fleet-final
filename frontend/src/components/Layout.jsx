import { Car, Users, BookOpen, GasPump, Warning, MapPin, ChartBar, Handshake, SignOut, List } from "@phosphor-icons/react";
    ...
    <div className="flex min-h-screen bg-[#F4F4F5]">
      ...
      <aside className="hidden lg:flex lg:flex-col sidebar" data-testid="desktop-sidebar">
        <div className="p-6 border-b border-[#E4E4E7]">
          <h1 className="font-['Manrope'] text-xl font-bold text-[#18181B] tracking-tight">
            Fleet Manager
          </h1>
          <p className="text-sm text-[#52525B] mt-1">Autoškola</p>
        </div>
        ...
        <div className="p-4 border-t border-[#E4E4E7]">
          ...
          <button
            ...
            className="sidebar-link w-full mt-2 text-[#991B1B] hover:bg-red-50"
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-[#E4E4E7]">
        <div className="flex items-center justify-between px-4 py-3">
          <h1 className="font-['Manrope'] text-lg font-bold text-[#18181B]">
            Fleet Manager
          </h1>
          <button
        ...
        {mobileMenuOpen && (
          <div className="absolute top-full left-0 right-0 bg-white border-b border-[#E4E4E7] shadow-lg animate-fade-in">
            <nav className="py-2">
              ...
              <button
                onClick={handleLogout}
                className="flex items-center gap-3 px-4 py-3 text-sm text-[#991B1B] hover:bg-red-50 w-full"
              >
                <SignOut size={20} weight="duotone" />
                <span>Odhlásit se</span>
              </button>
